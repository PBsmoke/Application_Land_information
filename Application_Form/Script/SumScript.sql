/***********************************************
CREATE BY	: SARUN
CREATE DATE	: 20170412
DESCRIPTION	: ���ҧ���ҧ��ҹ/��ѡ�ҹ
***********************************************/
IF NOT EXISTS (SELECT TABLE_NAME FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_NAME='tbEvidence')
CREATE TABLE [dbo].[tbEvidence](
	[EvidenceID] [varchar](36) NOT NULL,
	[EvidenceCode] [varchar](50) NULL,
	[EvidenceName] [varchar](100) NULL,
	[EvidenceType] [varchar](50) NULL,
	[Detail] [varchar](500) NULL,
	[Path] [varchar](500) NULL,
	[CreatedBy] [varchar](36) NULL,
	[CreatedDate] [datetime] NULL,
 CONSTRAINT [PK_tbEvidence] PRIMARY KEY CLUSTERED 
(
	[EvidenceID] ASC
...
DESCRIPTION	: ���ҧ���ҧ�����ž�鹷��
***********************************************/
IF NOT EXISTS (SELECT TABLE_NAME FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_NAME='tbLand')
CREATE TABLE [dbo].[tbLand](
	[LandID] [varchar](36) NOT NULL,
	[VillageName] [varchar](50) NULL,
	[VillageNo] [varchar](10) NULL,
	[SubDistrict] [varchar](100) NULL,
	[District] [varchar](100) NULL,
	[Province] [varchar](100) NULL,
	[History] [varchar](500) NULL,
	[Distress] [varchar](500) NULL,
	[CreatedBy] [varchar](36) NULL,
	[CreatedDate] [datetime] NULL,
 CONSTRAINT [PK_tbLand] PRIMARY KEY CLUSTERED 
(
	[LandID] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
...
CREATE BY	: SARUN
CREATE DATE	: 20170412
DESCRIPTION	: ���ҧ���ҧ�ӴѺ�˵ء�ó�
***********************************************/
IF NOT EXISTS (SELECT TABLE_NAME FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_NAME='tbTimeLineHD')
CREATE TABLE [dbo].[tbTimeLineHD](
	[TimeLineHDID] [varchar](36) NOT NULL,
	[LandID] [varchar](36) NULL,
	[TimeLineDate] [datetime] NULL,
	[TimeLineEvent] [varchar](500) NULL,
	[Remark] [varchar](500) NULL,
	[CreatedBy] [varchar](36) NULL,
	[CreatedDate] [datetime] NULL,
 CONSTRAINT [PK_tbTimeLineHD] PRIMARY KEY CLUSTERED 
(
	[TimeLineHDID] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
...
DESCRIPTION	: ���ҧ���ҧ��������´�ӴѺ�˵ء�ó�
***********************************************/
IF NOT EXISTS (SELECT TABLE_NAME FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_NAME='tbTimeLineDT')
CREATE TABLE [dbo].[tbTimeLineDT](
	[TimeLineDTID] [varchar](36) NOT NULL,
	[TimeLineHDID] [varchar](36) NULL,
	[EvidenceID] [varchar](36) NULL,
	[CreatedBy] [varchar](36) NULL,
	[CreatedDate] [datetime] NULL,
 CONSTRAINT [PK_tbTimeLineDT] PRIMARY KEY CLUSTERED 
(
	[TimeLineDTID] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
...
ALTER TABLE [dbo].[tbTimeLineDT]  WITH CHECK ADD FOREIGN KEY([EvidenceID])
REFERENCES [dbo].[tbEvidence] ([EvidenceID])
GO

ALTER TABLE [dbo].[tbTimeLineDT]  WITH CHECK ADD FOREIGN KEY([TimeLineHDID])
REFERENCES [dbo].[tbTimeLineHD] ([TimeLineHDID])
GO
...
DESCRIPTION	: ���ҧ���ҧ�����
***********************************************/
IF NOT EXISTS (SELECT TABLE_NAME FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_NAME='tbUser')
...
IF NOT EXISTS (SELECT TABLE_NAME FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_NAME='tbSettingPath')
CREATE TABLE [dbo].[tbSettingPath](
	[SettingPathID] [varchar](36) NULL,
	[SettingPath] [varchar](2000) NULL,
...
INSERT INTO tblamphures (AMPHUR_ID, AMPHUR_CODE, AMPHUR_NAME, GEO_ID, PROVINCE_ID) VALUES
...
CREATE TABLE tblbuddhism_geo (
  bgeo_id int NOT NULL ,
  bgeo_name varchar(100) NOT NULL,
  PRIMARY KEY (bgeo_id)
);
...
INSERT INTO tblbuddhism_geo (bgeo_id, bgeo_name) VALUES
(1, 'ภาค 1'),
(2, 'ภาค 2'),
(3, 'ภาค 3'),
(4, 'ภาค 4'),
...
INSERT INTO tbldistricts (DISTRICT_ID, DISTRICT_CODE, DISTRICT_NAME, AMPHUR_ID, PROVINCE_ID, GEO_ID) VALUES
...
INSERT INTO tblgeography (GEO_ID, GEO_NAME) VALUES
(1, 'ภาคเหนือ'),
(2, 'ภาคกลาง'),
...
INSERT INTO tblprovinces (PROVINCE_ID, PROVINCE_CODE, PROVINCE_NAME, GEO_ID) VALUES
...
--
-- Dumping data for table tblzipcodes
--

INSERT INTO tblzipcodes (zipid, district_code, zipcode) VALUES
(1, '100101', '10200'),
(2, '100102', '10200'),
(3, '100103', '10200'),
(4, '100104', '10200'),
...
IF EXISTS (SELECT * FROM sys.views WHERE name = 'uv_Timeline')
	DROP VIEW uv_Timeline
GO
CREATE VIEW dbo.uv_Timeline AS
SELECT THD.LandID
	,DATEADD(year,543,THD.TimeLineDate) AS TimeLineDate
	,THD.TimeLineEvent
	,THD.Remark
	,E.EvidenceCode
	,E.EvidenceName
	,E.EvidenceType
FROM tbTimeLineHD AS THD
	LEFT JOIN tbTimeLineDT AS TDT ON THD.TimeLineHDID = TDT.TimeLineHDID
	LEFT JOIN tbEvidence AS E ON TDT.EvidenceID = E.EvidenceID
